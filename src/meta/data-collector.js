        ...
        return {
          insertOne: {
            document: {
              ...
              learning_stage: info.learning_stage_info?.status || null,
              learning_stage_conversions: info.learning_stage_info?.conversions || 0,
              learning_stage_last_edit: info.learning_stage_info?.last_sig_edit_ts ? new Date(info.learning_stage_info.last_sig_edit_ts * 1000) : null,
              metrics,
              analysis: this._buildAnalysis(metrics),
